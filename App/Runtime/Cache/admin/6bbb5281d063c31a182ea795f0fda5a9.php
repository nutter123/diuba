...
<?php if(is_array($find)): $i = 0; $__LIST__ = $find;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
<td>
<img src="/diuba/Public/Uploads/findphoto/<?php echo ($vo["picture"]); ?>" style="height: 30px"></td>
<td><?php echo ($vo["goods_name"]); ?></td>
<td><?php echo ($vo["username"]); ?></td>
<td><?php echo ($vo["fname"]); ?></td>
<td><?php echo ($vo["place"]); ?></td>
<td><?php echo ($vo["telephone"]); ?></td>
<td><?php echo ($vo["finddate"]); ?></td>
<td><?php echo ($vo["createtime"]); ?></td>

<td>
<a href="delfind/id/<?php echo ($vo["id"]); ?>" style="color: #666">删除</a>

<a  href="listfind/id/<?php echo ($vo["id"]); ?>" style="color: #666">查看详细</a>
